...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #2D2A70">
      <a href="/dashboard-satpam" class="brand-link logo-switch" style="text-align: center; text-decoration:none;background-color: #fff" >
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="color: white">
          ...
          @auth
              <li class="nav-item">
                <a href="/dashboard-satpam" class="nav-link">
              ...
              <li class="nav-item">
                <a href="/recap-satpam" class="nav-link">

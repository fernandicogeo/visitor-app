...
<head>
    ...
    <title>Staff - Jadwal Pertemuan Divisi {{ Auth::user()->divisi }} - Bulan: {{ $request->bulan }}, Tahun: {{ $request->tahun }}</title>
...
<body>
    <h3>Staff - Jadwal Pertemuan Divisi {{ Auth::user()->divisi }} - Bulan: {{ $request->bulan }}, Tahun: {{ $request->tahun }}</h3>
    <table class="table">
        <thead>
          <tr>
            <th scope="col">No</th>
